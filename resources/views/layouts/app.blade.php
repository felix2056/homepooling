...
<body class="d-flex-column">
	<div id="app{{ isset($searchProps) && $searchProps ? ' search_properties' : '' }}">
		...
		@endif
		@endif
		<section class="notification-bar" id="notification">
			<div class="nav-container">
				<div class="white mlr23" aria-hidden="true">
					<div class="nfy-container">
						<i class="fas fa-info-circle"></i><span> hello world </span>
					</div>
				</div>
			</div>
		</section>
	...
	<footer id="footer" role="contentinfo">
      ...
      <div class="col-md-4 text-center">
        <div style="margin-left: -6px"><img src="/storage/img/logo.png" style="height: 30px"/></div>
      </div>
      <div class="col-md-4">
