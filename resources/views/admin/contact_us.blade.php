        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <form  id="contactUsForm" action="{{URL::Route('admin.contact_us')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="contact@yoursiteemail.com" value="@if($email){{ $email->meta_value }}@endif" maxlength="255" required />
                                <span class="glyphicon glyphicon-info form-control-feedback"></span>
