							<div role="tabpanel" class="tab-pane fade tab_edit" id="room" aria-labelledby="room-tab">
								<div class="tab_title">
								...
								<div class="tab_section" style="margin-top: 10px;">
									...
									<div class="checkbox_wrapper">
										<input {{ (isset($property->price) || isset($property->deposit) || isset($property->bills)) ? 'checked selected' : ''}} id="rooms_same_data" name="rooms_same_data" type="checkbox" value="1" /><label for="rooms_same_data" class="nonewstyle" style="color: #333">Rooms have the same price</label>
									</div>
								</div>
