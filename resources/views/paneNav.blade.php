<ul class="nav nav-tabs custom-navtabs col-lg-12 col-xs-12 col-md-12 col-sm-12" role="tablist">
		<li role="presentation" class="active col-lg-4 col-xs-4 col-sm-4 col-md-4">
		...
		<li role="presentation" class="col-lg-4 col-xs-4 col-sm-4 col-md-4">
